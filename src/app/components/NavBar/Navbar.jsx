...
export default function Navbar() {
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <button className="px-5 py-2 text-sm font-bold bg-cyan-400 text-black rounded-lg hover:bg-cyan-300 transition-all shadow-[0_0_15px_rgba(34,211,238,0.2)]">
                Iniciar Proyecto
            </button>
            </div>
        ...
        >
            ...
            <div className="mt-8 pt-6 border-t border-slate-800">
                <button className="w-full py-3 bg-cyan-400 text-black text-lg font-bold rounded-xl shadow-[0_0_15px_rgba(34,211,238,0.2)] hover:bg-cyan-300 transition-all active:scale-[0.98]">
                Iniciar Proyecto
                </button>
            </div>
            </div>
